...
import { X, Save, Upload, ChevronRight, ChevronLeft } from "lucide-react";
...
export const EditProductModal: FC<EditProductModalProps> = ({
    ...
    const step1Valid = formData.name && formData.name.trim() && formData.price && formData.price > 0;
            ...
            >
                ...
                >
                    <div className="flex items-center gap-2.5">
                        ...
                        <h2 className="text-sm font-bold text-[#111827]">Edit Product</h2>
                    </div>
                    <button
                        onClick={handleClose}
