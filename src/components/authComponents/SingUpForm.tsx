            ...
            <div className="w-full max-w-md">
                ...
                <form className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                        ...
                        <div>
                            <label htmlFor="profileImage" className="block font-medium text-[rgb(var(--foreground))] mb-1">
                                Profile Image <span className="text-[rgb(var(--text-muted))]">( Optional)</span>
                            </label>
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-[rgb(var(--surface-muted))] border border-[rgb(var(--border))] rounded-full flex items-center justify-center overflow-hidden">
                                    <span className="text-[rgb(var(--text-muted))] text-xs">?</span>
                                </div>
                                <button
                                    type="button"
                                    className="px-4 py-2 border border-[rgb(var(--border))] rounded-md bg-[rgb(var(--surface))] text-[rgb(var(--foreground))] hover:bg-[rgb(var(--surface-muted))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))]"
                                >
                                    Upload
                                </button>
                            </div>
